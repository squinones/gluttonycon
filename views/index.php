...
<div id="main">
    <div class="box alt container">
        ...
        <section class="feature left">
            <a href="#" class="image icon fa-heart"></a>
            <div class="content">
                <h3>Food</h3>
        ...
        <section class="feature left">
            ...
            <div class="content">
                <h3>Food</h3>
                <p>Eat until it hurts even more.</p>
            </div>
        </section>
    </div>
...
<div id="footer">
    <div class="container 75%">
        ...
        <ul class="copyright">
            <li>&copy; GluttonyConf. All rights reserved.</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
        </ul>
